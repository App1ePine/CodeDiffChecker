  ...
  <div class="page">
    ...
    <el-row :gutter="16" class="editor-row">
      <el-col :span="24" :md="12">
        <el-card class="editor-card">
          ...
          <el-input v-model="leftContent" :rows="12" class="editor-input" placeholder="Paste original code here..."
      ...
      <el-col :span="24" :md="12">
        <el-card class="editor-card">
          ...
          <el-input v-model="rightContent" :rows="12" class="editor-input" placeholder="Paste changed code here..."
            resize="none" type="textarea" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-card class="controls-card" shadow="never">
      <el-space :size="16" wrap>
        ...
        <el-switch v-model="fastDiffEnabled" active-text="Fast diff" inline-prompt inactive-text="Precise"
          size="large" />
        <el-switch v-model="wrap" active-text="Wrap" inactive-text="No wrap" inline-prompt size="large" />
        <el-switch v-model="highlight" active-text="Highlight" inactive-text="Plain" inline-prompt size="large" />
    ...
    <el-alert v-if="!authStore.isAuthenticated" type="info" title="Want to share diffs?"
      description="Create an account to save, hide, expire, and delete share links." show-icon class="share-hint" />

    <el-alert v-if="lastShareUrl" type="success" show-icon title="Your share link is ready" class="share-result">
      <template #default>
        <p>
    ...
    <el-dialog v-model="shareDialogVisible" title="Create share link" width="460px">
      <el-form label-position="top">
        ...
        <el-form-item label="Visibility">
          <el-switch v-model="shareForm.hidden" active-text="Hidden (only people with the link)" inactive-text="Listed"
            inline-prompt />
        </el-form-item>
        ...
        <el-form-item label="Expiration (optional)">
          <el-date-picker v-model="shareForm.expiresAt" format="YYYY-MM-DD HH:mm:ss" type="datetime"
            value-format="YYYY-MM-DD HH:mm:ss" clearable placeholder="No expiration" />
        </el-form-item>
      </el-form>
