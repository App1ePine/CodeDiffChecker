      ...
      <el-skeleton :loading="loading" animated :rows="6">
        <template #default>
          ...
          <div v-else class="share-list">
            <el-card v-for="share in shares" :key="share.slug" shadow="hover" class="share-card">
              <div class="share-row">
          ...
          <div v-if="shares.length" class="pagination-bar">
            <el-pagination :current-page="page" :page-size="pageSize" :page-sizes="[12, 18, 24]" :total="total"
              layout="prev, pager, next, sizes" @current-change="handlePageChange"
